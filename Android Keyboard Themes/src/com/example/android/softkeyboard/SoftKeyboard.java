...
public class SoftKeyboard extends InputMethodService 
    ...
    /*
        ...
        switch(applicationPrefs.getThemesId())
        {
        	...
        	case 1000:
        		mInputView = (LatinKeyboardView) getLayoutInflater().inflate(applicationPrefs.getCustomeThemesBackground(), null);
        		 File file = new File(Environment.getExternalStorageDirectory()+ File.separator + "keyboardback.jpg"); 
        		 Bitmap photo = getPreview(file.toString());
        		 Drawable d = new BitmapDrawable(getResources(), file.toString());
        		 mInputView.setBackground(d);
        		break;
        	
        	/*case 2:
        		Toast.makeText(getApplicationContext(), 2+"", Toast.LENGTH_LONG).show();
        		 mInputView = (LatinKeyboardView) getLayoutInflater().inflate(R.layout.input, null);
        		 Drawable d = new BitmapDrawable(getResources(), session.getBitmap());
        		 mInputView.setBackground(d);
        		break;
